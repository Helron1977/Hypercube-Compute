...
## 🧪 Showcase
- [06: V8 Heat GPU](./showcase/gpu/heat-gpu.html) : Performance maximale avec double-buffering matériel.
- [07: V8 Heat CPU](./showcase/cpu/heat-cpu.html) : Preuve du contrat agnostique (zéro changement de code logique).
